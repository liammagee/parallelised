...
var right_gutter_width=Math.round(($('#theatre-ia-wrap').width()-$('#theatre-controls').width()-width)/2);log('width: '+width);log('right_gutter_width: '+right_gutter_width);$('#theatre-controls').css({height:height,visibility:'visible',right:Math.max(20,right_gutter_width/2)});};AJS.booksize=function(){// Lendable books have a dialog in iframe, and use a different book sizing
